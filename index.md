...
<tbody>
  <tr>
    <td>Which AI model (s) is capable of <br>generating this explanation type?<br>E.g. E.g. Which AI model is capable of generating <br>a trace-based explanation?</td>
    <td>System <br>Planning</td>
    <td>Knowledge-based systems<br>Machine learning model: decision trees</td>
  </tr>
  <tr>
    <td>What example questions have been<br>identified for counterfactual explanations?</td>
    <td>System <br>Planning</td>
