...
<p class="message">A website to navigate resources open-sourced via the associated ISWC 2020 submission. Use the side navigation panel to explore different sections of the website, and click on a add symbol for more navigation options under some sections. </p>
